...
public class Kubusje {
    ...
    // Onderstaande constanten zorgen ervoor dat code leesbaar en snel
    // controleerbaar is.
    // Ze bepalen de volgorde waarin de vlakken opgeslagen worden in de array
    // 'vlakjes'.
    ...
    // Merk op: de bovenstaande hoekpunten werden in een specifieke volgorde
    // opgesomd.
    // Als de hoekpunten in die volgorde overlopen worden en dus aan vlakken
    // toegekend worden,
    // dan zullen ze altijd in wijzer- of tegenwijzerzin toegevoegd worden - maar
    // nooit 'kriskras'.
    // $**********
    // / / *
    // *********** *
    ...
    // * * *
    // @---------*
    // Start bij @, volg de sterretjes, en voeg elk hoekpunt dat je tegenkomt in die
    // volgorde toe.
    ...
    // (3) alle zijvlakjes (waarbij een zijvlakje zelf weet hoe 't zich omzet in een
    // String)
    ...
    public Point3D getCentrum() {
        return centrum.getLocation();
    }
